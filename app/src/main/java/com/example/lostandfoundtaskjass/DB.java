...
public class DB extends SQLiteOpenHelper {
    public DB(@Nullable Context context) {
        super(context, "lost_and_found_db", null, 1);
    }
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(CREATE_LOST_FOUND_ITEMS_TABLE);
    }

    @Override
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS LOST_FOUND_ITEMS;");
    ...
    public void insertItem(Items item) {
        ...
        values.put("post_type", item.getPost_type());
    ...
    public List<Items> getItems() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                item.setPost_type(cursor.getInt(6));
                itemList.add(item);
